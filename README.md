...
| 📧 **Email уведомления** | Регистрация и сброс пароля через Gmail |
...
> **Windows:** можно использовать `start-win.bat` для одновременного запуска backend и frontend.
...
| Файл | Назначение |
|------|-----------|
| `clean_database_script.sql` | Полная очистка всех данных (оставляет структуру) |
